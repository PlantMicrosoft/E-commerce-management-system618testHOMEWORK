...
public class CartController {
    ...
    public ResponseEntity<ApiResponse<CartDTO>> getCart(
        ...
        CartDTO cart = cartService.getCartByCustomerId(userPrincipal.getId());
    ...
    public ResponseEntity<ApiResponse<List<CartItemDTO>>> getCartItems(
        ...
        List<CartItemDTO> cartItems = cartService.getCartItems(userPrincipal.getId());
    ...
    public ResponseEntity<ApiResponse<CartItemDTO>> addToCart(
        ...
        CartItemDTO cartItem = cartService.addToCart(userPrincipal.getId(), request);
    ...
    public ResponseEntity<ApiResponse<CartItemDTO>> updateCartItem(
        ...
        CartItemDTO cartItem = cartService.updateCartItem(
                userPrincipal.getId(), cartItemId, request);
